...
function drawHiddenWord(hiddenWord) {
...
// function checkLetter(letter, button, hiddenWord, wordLetters) {
...
//     checkLetter(letter, button, hiddenWord,wordLetters);
//   });
// }
...
//         } else if (bodyPartsP1 === (maxBodyParts - 1)) {
...
//           // console.log(bodyParts, maxBodyParts)
//         } else if (bodyPartsP2 === (maxBodyParts - 1)) {
//           showModalLoser("Você perdeu, seu tempo acabou!")
//           //verificarEAtualizarMoedas(-100)
//         }
//       }
...
function drawBodyPart(imgValor, player) {
  if (player) {
